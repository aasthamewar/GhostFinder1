  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero:
          "bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.98]",
        glow:
          "bg-primary text-primary-foreground shadow-glow hover:shadow-xl hover:shadow-primary/40",
        ghost_status:
          "bg-ghost/10 text-ghost border border-ghost/30 hover:bg-ghost/20",
        stalled_status:
          "bg-stalled/10 text-stalled border border-stalled/30 hover:bg-stalled/20",
        active_status:
          "bg-active/10 text-active border border-active/30 hover:bg-active/20",
      },
      size: {
